  ...
  return (
    <div className="container h-100 trinery-bg">
      <nav className="mobile-nav py-4">
        <Link
          href="/"
          className="d-flex mb-3 align-items-center text-decoration-none logo"
        >
        ...
        <Link href="/hotel" className="mobile-link" onClick={setIsMenuOpen}>
          {t("hotel")}
        </Link>
        <Link
          href="/rental-car"
        ...
        <Link href="/blog" className="mobile-link" onClick={setIsMenuOpen}>
          {t("blog")}
        </Link>
        <Link
          href="/contact-us"
        ...
        <div className="mobile-actions mt-4">
          <div>
            <h3 className="footer-heading poppins">
            ...
            <ul className="list-unstyled footer-contact">
              <li className="d-flex mb-3">
                ...
                <a
                  href="https://maps.app.goo.gl/jmXZeK4ETp27DPaq9"
                  target="_blank"
                  className="text-dark poppins small-base text-decoration-none d-block"
                >
              ...
              <li className="d-flex mb-3 poppins">
                ...
                <div>
                  <a
                    href="tel:+917507778088"
                    className="footer-link text-decoration-none small-base text-dark d-block"
                  >
                    +91 7507778088
                  </a>
                </div>
              ...
              <li className="d-flex poppins">
                ...
                <div className="d-flex flex-column">
                  <a
                    ...
                    className="footer-link text-decoration-none small-base text-dark"
                  >
