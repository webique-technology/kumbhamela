...
export async function generateMetadata({ params }) {
    ...
    // Load translations scoped to the HotelReservations namespace
    ...
    const pageSlug = "hotel-reservation";
    ...
    return {
        ...
        openGraph: {
            ...
            images: [
                {
                    url: `${baseUrl}/images/hotels-og-banner.jpg`,
                    width: 1200,
                    height: 630,
                    alt: metaTitle,
                }
        ...
        twitter: {
            ...
            title: metaTitle,
            description: metaDescription,
            images: [`${baseUrl}/images/hotels-og-banner.jpg`],
        }
    };
}
