...
export async function generateMetadata({ params }) {
    ...
    // Load translations scoped to the PassportAssistance namespace
    ...
    const pageSlug = "passport-assistance";
    ...
    return {
        ...
        openGraph: {
            ...
            images: [
                {
                    url: `${baseUrl}/images/passport-og-banner.jpg`,
                    width: 1200,
                    height: 630,
                    alt: metaTitle,
                }
        ...
        twitter: {
            ...
            title: metaTitle,
            description: metaDescription,
            images: [`${baseUrl}/images/passport-og-banner.jpg`],
        }
    };
}
