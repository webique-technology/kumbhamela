...
const TouristDestinations = () => {
  ...
  const tabsMeta = {
    jyotirlingas12: {
      icon: Crown,
      packageLink: "12-jyotirlinga-yatra-with-mahakumbh-tours-travels-nashik",
      count: 12,
    },
    mahaJyotirlingas: {
      icon: Milestone,
      packageLink: "5-jyotirlinga-pilgrimage-in-maharashtra",
      count: 5,
    },
    unescoSites: {
      icon: Landmark,
      packageLink:
        "2-nights-3-days-unesco-heritage-ajanta-ellora-caves-tour-from-nashik",
      count: 4,
    },
    shaktiPeethas: {
      icon: ShieldCheck,
      packageLink: "sade-tin-35-shakti-peeth-tour-package",
      count: 4,
    },
    ashtavinayak8: {
      icon: Heart,
      packageLink: "ashtavinayak-tour-package-for-3-days",
      count: 8,
    },
    hillStations: {
      icon: Sparkles,
      packageLink:
        "5-nights-6-days-lonavala-khandala-mahabaleshwar-tour-package-from-nashik",
      count: 3,
    },
  };
    ...
    <section className="tourist-destinations-section py-5 trinery-bg">
      <Container className="py-4">
        ...
        <Tab.Container
          ...
          onSelect={(k) => setActiveTabKey(k || "jyotirlingas12")}
        >
          <Row className="g-4">
            {/* Navigation Tabs Header Stack */}
            <Col lg={12}>
              <AnimationSecComponent type="vertical" direction="up" delay={0.4}>
                  ...
                  {tabKeys.map((key) => {
                    ...
                    return (
                      <Nav.Item key={key}>
                        <Nav.Link
                          eventKey={key}
                          className={`w-100 p-2 px-2 px-lg-2 rounded-3 d-flex align-items-center justify-content-between transition-all border ${
                            isActive
                        ...
                        >
                          <div className="d-flex align-items-center gap-3">
                            <div
                              className={`icon-frame p-1 p-lg-2 rounded-2 ${
                                isActive
                            ...
                            <span className="fw-semibold pill-title-text">
                              {tabsDataRaw[key]?.title}
                            </span>
                          </div>
                ...
                {tabKeys.map((key) => {
                  ...
                  return (
                    <Tab.Pane
                      eventKey={key}
                      key={key}
                      className="transition-fade-pane"
                    >
                      <AnimationSecComponent
                        type="vertical"
                        direction="up"
                      ...
                      >
                        <div className="destination-details-wrapper p-4 p-md-5 bg-white rounded-4 border shadow-sm">
                                ...
                                >
                                  <div className="sub-location-item-card p-3 rounded-3 border w-100 d-flex flex-column transition-all bg-light-card-bg">
                                    <div className="d-flex align-items-center gap-2 mb-2">
                                      <MapPin
                                        size={16}
                                        className="primery-color flex-shrink-0"
                                      />
                                    ...
                                    <p className="m-0 small text-muted lh-base line-clamp-3 mb-3">
                                      {subItem.text}
                                    </p>

                                    {/* FIXED BUTTON: Pass mapped payload with title & long description */}
                                    <button
                                      type="button"
                                      className="bg-transparent p-0 border-0 d-flex align-items-center mt-auto"
                                      onClick={() =>
                                        handleOpenPopup({
                                          title: subItem.name,
                                          description: subItem.text,
                                          routeLink: Meta.packageLink
                                            ? `/tour-package/${slugify(
                                                Meta.packageLink,
                                              )}`
                                            : null,
                                        })
                                    ...
                                    >
                                      <span className="primery-color fw-semibold small">
                                        {tDest("readMore")} <span>&rarr;</span>
                                      </span>
                                    </button>
                                  </div>
                                </Col>
                          ...
                          {Meta.packageLink && (
                            <div className="d-flex justify-content-start align-items-center mt-4 small-12">
                              <p className="m-0 small-12">
                                {tDest("moreInfo")}
                              </p>
                              <Link
                                href={`/tour-package/${slugify(
                                  Meta.packageLink,
                                )}`}
                                target="_blank"
                                className="text-decoration-none"
                              >
                                <button className="border-0 primery-color bg-white ms-1 fw-semibold">
...
const AboutPage = () => {
  ...
  const historyCards = [
    {
      id: 1,
      badge: historyCardsRaw.card1.badge,
      title: historyCardsRaw.card1.title,
      desc: historyCardsRaw.card1.desc,
    },
    {
      id: 2,
      badge: historyCardsRaw.card2.badge,
      title: historyCardsRaw.card2.title,
      desc: historyCardsRaw.card2.desc,
    },
    {
      id: 3,
      badge: historyCardsRaw.card3.badge,
      title: historyCardsRaw.card3.title,
      desc: historyCardsRaw.card3.desc,
    },
    {
      id: 4,
      badge: historyCardsRaw.card4.badge,
      title: historyCardsRaw.card4.title,
      desc: historyCardsRaw.card4.desc,
    },
  ];
  ...
  const cycleCards = [
    {
      id: "01",
      title: cycleCardsRaw.card1.title,
      text: cycleCardsRaw.card1.text,
      img: sadhusSaints.src,
    },
    {
      id: "02",
      title: cycleCardsRaw.card2.title,
      text: cycleCardsRaw.card2.text,
      img: yearCycle2.src,
    },
    {
      id: "03",
      title: cycleCardsRaw.card3.title,
      text: cycleCardsRaw.card3.text,
      img: riverRituals.src,
    },
    {
      id: "04",
      title: cycleCardsRaw.card4.title,
      text: cycleCardsRaw.card4.text,
        ...
        <Container className="hero-content-wrapper">
          <div className="max-w-700 d-flex flex-column align-items-center align-items-lg-start">
            ...
            <h1 className="hero-title mb-2 text-light">
              {t("Hero.title")}{" "}
              <span className="hero-span primery-color">
                {t("Hero.subtitle")}
              </span>
            </h1>
        ...
        <Container>
          <Row className="align-items-center justify-content-center">
            <Col md={6} className="hero-text-col">
              ...
              <p className="description-text mt-4">{t("Legacy.description")}</p>
          ...
          <div className="d-flex flex-column gap-4">
            ...
            <div className="accordion-card p-4 shadow-sm bg-white">
              <Accordion
                ...
                flush
                className="custom-faq-accordion w-100"
              >
                {faqKeys.map((key) => {
                  const item = faqRaw[key];
                  const listItemKeys = item.listItems
                    ? Object.keys(item.listItems)
                    : [];
                      ...
                      <Accordion.Body className="bg-white p-4 text-secondary">
                        {item.listItems ? (
                          <div className="faq-list-content-flow">
                            {item.leadText && (
                              <p className="mb-3 lead-text-desc">
                                {item.leadText}
                              </p>
                            )}
                            <ul className="faq-bullet-group ps-3 mb-3">
                              {listItemKeys.map((liKey) => (
                                <li
                                  key={liKey}
                                  className="mb-2 faq-list-bullet-item lh-base"
                                >
            ...
            {ritualKeys.map((key) => {
              ...
              return (
                <Col md={6} lg={4} key={key} className="d-flex">
                  ...
                  >
                    <div
                      className={`ritual-event-card w-100 shadow-sm p-4 rounded-4 d-flex flex-column transition-all ${
                        meta.isActive ? "active-highlight-card" : ""
                      }`}
                    >
                      ...
                      <div className="card-titles-meta mb-3">
                        <h3 className="h4 card-main-title mb-1 fw-bold">
                          {data.title}
                        </h3>
                      ...
                      <p className="card-description-text text-white-60 small lh-base mb-3 line-clamp-4">
                        {data.description}
                      </p>
          ...
          <Row className="mt-2 g-4">
            {cycleCards.map((card) => (
              <Col xs={12} md={6} key={card.id}>
                <div className="cycle-card border p-4 shadow-sm rounded-4 bg-white h-100 d-flex flex-column flex-md-row gap-4 align-items-stretch">
                  {/* Image Container - Fixed Width on Desktop, Responsive */}
                  <div className="img-box overflow-hidden flex-shrink-0">
                    <img
                      src={card.img}
                      alt={card.title}
                      className="img-fluid"
                  ...
                  {/* Content Container */}
                  <div className="content-box d-flex flex-column justify-content-center">
                    <span className="badge bg-light primery-color align-self-start mb-2 px-3 py-2 rounded-pill fw-medium">
                      HERITAGE
                    </span>
                    <h3 className="h4 fw-bold mb-2">{card.title}</h3>
                    <p className="text-muted small mb-0 lh-base">{card.text}</p>
                  </div>
                </div>
              </Col>
            ))}
